...
vke::VulkanSwapChain::VulkanSwapChain(ptrVkEngine _vke, bool vsync) {
    vke = _vke;
...
vke::VulkanSwapChain::~VulkanSwapChain()
{
...
void vke::VulkanSwapChain::create(uint32_t& width, uint32_t& height)
{

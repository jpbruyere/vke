...
namespace vke
{
    ...
    VkWriteDescriptorSet Texture::getWriteDescriptorSet (VkDescriptorSet ds, uint32_t binding, VkDescriptorType descriptorType) {
    ...
    void Texture::createSampler (VkFilter filter, VkSamplerAddressMode addressMode,
    ...
    void Texture::buildMipmaps (VkQueue copyQueue, VkCommandBuffer _blitCmd) {

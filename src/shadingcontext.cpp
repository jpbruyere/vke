...
namespace vke {
    ...
    uint32_t ShadingContext::addDescriptorSetLayout (const std::vector<VkDescriptorSetLayoutBinding>& descriptorSetLayoutBinding) {
        uint32_t idx = descriptorSetLayoutBindings.size();
        descriptorSetLayoutBindings.push_back (descriptorSetLayoutBinding);
        return idx;
    }

    void ShadingContext::prepare () {
    ...
    VkDescriptorSet ShadingContext::allocateDescriptorSet (uint32_t layoutIndex) {
    ...
    void ShadingContext::updateDescriptorSet (VkDescriptorSet ds, const std::vector<BindingSlot>& slots) {
